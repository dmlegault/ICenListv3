...
public sealed class RunnerHost
{
    ...
    public async Task RunAsync(CancellationToken processExit)
    {
        ...
        while (!processExit.IsCancellationRequested)
        {
            ...
            // called ReceiveAsync again: a twenty-second synchronous job made Cancel, Stop and even
            // Shutdown sit unread until it was over, which is exactly when they are least useful.
            //
