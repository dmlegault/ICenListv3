...
/// {AssemblyName}.settings.json) next to its DLL — same convention as the modern Enlist.Runner's own
/// SettingsLoader, flattened into IDictionary&lt;string,string&gt; since that's the only settings
/// shape the zero-package contract can express (design doc section 3).
/// </summary>
